    ...
    <div className="flex flex-col items-center pt-16 md:pt-24 pb-20 px-4">
      <div className="w-full max-w-[450px] space-y-8">
        <div className="flex flex-col space-y-2 text-center">
          <h1 className="text-3xl font-black italic tracking-tighter uppercase">Sign Up</h1>
          ...
          <CardContent className="pt-8 px-8 space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="uppercase tracking-widest font-bold text-[10px]">Full Name</Label>
                <Input 
                  id="name" 
